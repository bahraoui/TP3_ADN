...
int recChemins(posDamier d, char m[4][4], int matvisite[4][4], int prof, char *chemin, Noeud *, Cellule ** tabh, unsigned int taille);
/* Lancement de la recherche de solutions                                     */
int chemins(char m[4][4], Noeud *, Cellule ** tabh, unsigned int taille);
